...
import { utm33, golfMoisture, rainSummary, greenspeed, classifySnow, waxAdvice, accuracyStats, precipEvents, evidenceLevel, shrunkBias, walkForwardBacktest, aggregateForecastDays } from '../static/vaerdata/models.mjs';
